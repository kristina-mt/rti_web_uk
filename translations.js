...
`,
    ...
    "lockout-text": `
Car lockouts can happen to anyone – and always at the worst possible moment.<br>
Whether it’s due to lost or stolen keys, a broken lock, or accidentally locking your keys inside the vehicle – <strong>we’re here to help</strong>.<br>
Our professional locksmiths are available <strong>24/7</strong> and can reach you quickly, wherever you are.<br>
...
`,
    ...
    "lockout-text": `
Automobilio užrakinimas gali nutikti kiekvienam – ir dažniausiai pačiu blogiausiu metu.<br><br>
Pamesti, pavogti raktai, sugedusios spynos ar netyčia užrakinti raktai automobilyje – <strong>mes pasiruošę padėti</strong>.><br>
Mūsų profesionalūs meistrai dirba <strong>24/7</strong> ir greitai atvyksta bet kurioje vietoje.<br>
...
`,
    ...
    "lockout-text": `
Заблокировать автомобиль может каждый – и чаще всего это происходит в самый неподходящий момент.<br><br>
Потерянные или украденные ключи, поломка замка или ключи остались в машине – <strong>мы готовы помочь</strong>.<br><br>
Наши профессиональные мастера работают <strong>круглосуточно</strong> и приедут к вам быстро, где бы вы ни находились.<br><br>
...
`,
    ...
    "key-replacement-title": "Замена автомобильного ключа",
"key-replacement-text": `
...
`,
    ...
    "lockout-text": `
Zatrzaśnięcie auta może przydarzyć się każdemu – zwykle w najmniej odpowiednim momencie.<br><br>
Zgubione lub skradzione klucze, uszkodzony zamek albo pozostawione klucze w środku – <strong>jesteśmy tutaj, aby pomóc</strong>.<br><br>
Nasi fachowcy są dostępni <strong>24/7</strong> i szybko dotrą na miejsce.<br><br>
...
`,
    ...
    "key-replacement-title": "Wymiana klucza samochodowego",
"key-replacement-text": `
